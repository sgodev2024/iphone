...
class TransactionBusinessListService
{
    public function entries(array $ownerIds, Collection $moneyAccountIds, string $from, string $to): Collection
    {
        return DB::table('transactions as t')
            ...
            ->selectRaw('COALESCE(MAX(collection.collection_number), MAX(t.reference_number)) as reference_number')
            ->selectRaw('COALESCE(MAX(collection.collection_number), MAX(t.description)) as description')
