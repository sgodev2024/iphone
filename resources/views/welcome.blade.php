        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="metric-card">
                    ...
                    <div class="metric-value">{{ number_format($returnStats['returned_orders'],0,',','.') }}</div>
                    @if ($returnStats['returned_orders'] > 0)
                    <div class="metric-change negative">
                        <i class="fas fa-rotate-left"></i>
                        {{ number_format($returnStats['return_rate'],1,',','.') }}%tổng đơn hàng
                    </div>
                    @else
                    <div class="metric-change positive">
                        <i class="fas fa-check-circle"></i>
                        Chưa phát sinh hoàn trả
                    </div>
                    @endif
                </div>
            </div>
