...
<div class="card mb-3">
    ...
    <div class="card-body p-0">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover table-striped align-middle mb-0 return-products-table">

                <thead class="table-light">
                    <tr>
                        <th class="small">Sản phẩm</th>
                        <th class="text-end small">Đơn giá</th>
                        <th class="text-center small">Đã mua</th>
                        <th class="text-center small">Đã trả</th>
                        <th class="text-center small">Còn trả</th>
                        <th class="text-end small">Thao tác</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    @forelse ($returnItems as $item)
                        ...
                        <tr class="{{ !$item['can_return'] ? 'return-item-disabled' : '' }}">

                            {{-- Sản phẩm --}}
                            <td>

                                <div class="return-product-name small">
                                    {{ $item['product_name'] }}
                                </div>

                                <div class="return-product-meta small">
