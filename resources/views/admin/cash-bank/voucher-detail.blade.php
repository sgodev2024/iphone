        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6"><strong>Tài khoản tiền:</strong> {{ $voucher->cashAccount->code }} - {{ $voucher->cashAccount->name }}</div>
                    ...
                    <div class="col-12">
                        ...
                        @if ($voucher->attachment)
                            <a href="{{ route('admin.transactions.cash.vouchers.attachment', $voucher) }}" target="_blank">Xem file đính kèm</a>
                        @else
                            —
                        @endif
                    </div>
